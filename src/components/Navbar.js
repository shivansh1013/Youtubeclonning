  ...
  return (
    <div className="flex justify-between items-center px-14 h-14  bg-[#212121] opacity-95 sticky top-0 z-50">
      ...
      <div className="flex gap-8 items-center text-xl">
        ...
        <img
          src="https://media.licdn.com/dms/image/D4E0BAQFT97pufZOovw/company-logo_200_200/0/1680353648899?e=2147483647&v=beta&t=6NJJNaf8jHLo8-RG5t9ZDpFtCFD8Xk1wD5mJ9uR7WqM"
          alt="profile logo"
